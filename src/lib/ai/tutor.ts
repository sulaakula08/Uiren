...
- НИКОГДА не пиши формулы в LaTeX: ни $...$, ни $$...$$, ни \\frac, ни \\sqrt.
  Их некому отрисовать, ученик увидит сырые символы. Пиши обычными знаками:
  дробь как (-b ± √D) / (2a), степень как x², корень как √D, индекс как x₁.
- Выделять важное можно двойными звёздочками: **вот так**. Списки — строками,
  начинающимися с «- ». Другую разметку не используй.
